...
<div class="container">
    ...
    <!-- Contact Section -->
    <div class="mt-5">
        <h1 class="text-danger display-3">Contact Us</h1>
        <div class="contact-details">
            <!-- LinkedIn Link -->
            <p>LinkedIn: <a href="https://www.linkedin.com/in/your_linkedin_profile/">Swetha A</a></p>
            <!-- Phone Number -->
            <p>Phone Number: 6875069634</p>
            <!-- Address -->
            <p>Address: Purasaiwalkam,thandavan st ,chennai 07</p>
        </div>
    </div>
    ...
    <footer class="bg-dark text-light text-center py-3 mt-5">
        <div class="container">
            <p>&#169 SWETHA (212223220114) 2024 PharmaCo. All rights reserved.</p>
        </div>
    </footer>
</div>
...
![Screenshot 2024-05-14 082512](https://github.com/aswethaashok/Pharma/assets/149987410/c4779f11-7b36-468e-adbb-052e1663ddc7)
